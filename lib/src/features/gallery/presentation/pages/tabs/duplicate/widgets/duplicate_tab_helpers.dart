  ...
  try {
    ...
    for (final album in albums) {
      try {
        ...
        debugPrint(
          '⚠️ [DuplicateTab] Albüm sayısı alınamadı: ${album.name}, $e',
        );
    ...
    debugPrint('⚠️ [DuplicateTab] Tahmini süre hesaplanamadı: $e');
